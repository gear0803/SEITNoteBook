...
|                             课程                             |  学期   | 老师   |       作业/课设       |
| :----------------------------------------------------------: | :-----: | ------ | :----------------: |
| 数值计算方法 | 3 | 伍沛然 |  [MMSE-SQRD(含复数矩阵类、作业所用算法)](https://github.com/Yinshideguanghui/MMSE_VBLAST_QRD_SQRD)          |
| 图像处理 | 7 | 梁凡 |   [作业](https://github.com/Yinshideguanghui/Digital_Image_Processing)          |
